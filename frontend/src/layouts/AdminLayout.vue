...
const langMessages: Record<string, Record<string, string>> = {
  ...
  en: { header: 'Admin Panel', storeProfile: 'Store Profile', dashboard: 'Dashboard', knowledge: 'Knowledge Base', conversations: 'Conversations', config: 'Configuration API', config: 'API Config', back: 'Back to Chat' },
  ...
  fr: { header: 'Panneau Admin', dashboard: 'Tableau de bord', knowledge: 'Base de connaissances', conversations: 'Conversations', config: 'Configuration API', config: 'API Config', back: 'Retour au chat' },
